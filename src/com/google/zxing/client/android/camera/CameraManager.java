...
public final class CameraManager {
    ...
    public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
        ...
        // TODO On screen rotation sometimes throws:
        // IllegalArgumentException: Crop rectangle does not fit within image
        // data.

        PlanarYUVLuminanceSource yuv = null;
        try {
            yuv = new PlanarYUVLuminanceSource(rotation == Surface.ROTATION_0 ? rotatedData : data,
                    width, height, rect.left, rect.top, rect.width(), rect.height(), false);
        } catch (Exception e) {
        }
