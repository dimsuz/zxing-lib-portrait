...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        /*        // Remove action bar height
                ...
                DisplayMetrics displayMetrics = this.context.getResources()
                        .getDisplayMetrics();
    ...
    private Point findBestPreviewSizeValue(Camera.Parameters parameters, Point screenResolution) {
        ...
        if ((float)screenResolution.x > (float)screenResolution.y)
            screenAspectRatio = (float)screenResolution.x / (float)screenResolution.y;
        else
            screenAspectRatio = (float)screenResolution.y / (float)screenResolution.x;
